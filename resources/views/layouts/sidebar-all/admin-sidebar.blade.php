    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
            ...
            <ul id="students-menu" class="collapse">
                ...
                <li>
                    ...
                    <ul id="Graduate students" class="collapse">
                        <li> <a
                                href="{{ route('graduted.create') }}">{{ trans('main_trans.add_Graduate') }}</a>
                        </li>
                        <li> <a
                                href="{{ route('graduted.index') }}">{{ trans('main_trans.list_Graduate') }}</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a href="{{ route('fees.create') }}">{{ trans('fees.add_fees') }}</a> </li>
                <li> <a href="{{ route('Fees_Invoices.index') }}">{{ trans('fees.fees_invioce') }}</a>
                </li>
                <li> <a href="{{ route('receipts.index') }}">{{ trans('fees.fees_salary') }}</a> </li>
                <li> <a href="{{ route('processing_fees.index') }}">{{ trans('fees.fees_piad') }}</a>
                </li>
        ...
        <li>
            ...
            <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                <li><a
                        href="{{ route('students_Attendance.index') }}">{{ trans('main_trans.list_students') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('subjects.index') }}">{{ trans('main_trans.Subjects_List') }}</a>
                </li>
        ...
        <!-- Exams-->
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Exams-test">
                <div class="pull-left"><i class="fas fa-book-open"></i><span
                        class="right-nav-text">{{ trans('main_trans.Exams') }}</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="Exams-test" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('quizes.index') }}">{{ trans('attendance.exams_list') }} </a>
                </li>
                <li> <a href="{{ route('question.index') }}">{{ trans('attendance.question') }}</a> </li>
                <li> <a href="weather-icon.html">Weather icons</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('library.index') }}">{{ trans('attendance.librarys') }}</a> </li>
                <li> <a href="themify-icons.html">Themify icons</a> </li>
                <li> <a href="weather-icon.html">Weather icons</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('zoom.index') }}">حصص اونلاين</a> </li>
        ...
        <li>
            ...
            <ul id="Settings-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('setting.index') }}"> {{ trans('main_trans.Settings') }}</a> </li>
