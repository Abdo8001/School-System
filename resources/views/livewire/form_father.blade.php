    ...
    <div class="col-md-12">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <select  wire:model="Nationality_Father_id" class="custom-select my-1 mr-sm-2">
            ...
            <div class="form-group col">
                ...
                <select class="custom-select my-1 mr-sm-2" wire:model="Blood_Type_Father_id">
                    ...
                    @foreach ($Type_Bloods as $Type_Blood)
                        <option value="{{ $Type_Blood->id }}">{{ $Type_Blood->blood_type }}</option>
                    @endforeach
       ...
       @if ($update_mode)
       <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" wire:click="EditFirstSubmits"
       type="button">{{ trans('Parent_trans.Next') }}
   </button>
   @else
   <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" wire:click="firstStepSubmits"
   type="button">{{ trans('Parent_trans.Next') }}
</button>
       @endif
