...
@section('css')
    @toastr_css
@section('title')
{{ trans('fees.fees_invioce') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{ trans('fees.fees_invioce') }}    {{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                                    ...
                                    <div data-repeater-list="List_Fees">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name" class="mr-sm-2"> {{ trans('fees.Name') }}  </label>
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2"> {{ trans('fees.fees_kind') }}  </label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="description" class="mr-sm-2">{{ trans('grade_trans.Notes') }}</label>
                                                    <div class="box">
