                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="nationalitie_id">
                                        ...
                                        @foreach($Nationalities as $nationality)
                                            <option value="{{ $nationality->id }}" {{$nationality->id == $student->nationalitie_id ? 'selected' : ""}}>{{ $nationality->national_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="blood_id">
                                        ...
                                        @foreach($bloods as $blood)
                                            <option value="{{ $blood->id }}" {{$blood->id == $student->blood_id ? 'selected' : ""}}>{{ $blood->blood_type }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="Classroom_id">
                                        <option value="{{$student->Classroom_id}}">{{$student->classroom->calss_name}}</option>
                                    </select>
                                </div>
                            </div>
