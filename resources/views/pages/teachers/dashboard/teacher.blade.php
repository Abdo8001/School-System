 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0"> {{ trans('Sections_trans.Name_Teacher') }}:{{ auth()->user()->Name }}</h4>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('attendance.student_count')  }}</p>
                                    <h4>{{ $count['student_at_section']}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('student_at.all')}}" target="_blank"><span class="text-danger">عرض البيانات</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('attendance.sections_count') }}</p>
                                    <h4>{{$count['of_teaching_section']}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('SectionOfStudent')}}" target="_blank"><span class="text-danger">عرض البيانات</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                <tr  class="table-info text-danger">
                                                    ...
                                                    <th> {{ trans('attendance.created_at') }}</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr> <td>{{$loop->iteration}}</td>
                                                        ...
                                                        @empty
                                                        <td class="alert-danger" colspan="8">{{ trans('attendance.no_data') }}</td>
                                                    </tr>
                                                    @endforelse
                                    ...
                                    <div class="tab-pane fade" id="fee_invoices" role="tabpanel" aria-labelledby="fee_invoices-tab">
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                <tbody>
                                                @forelse($invoices as $section)
                                                    <tr>
                                                        <td>{{$loop->iteration}}</td>
                                                        <td>{{$section->invoice_date}}</td>
                                                        <td>{{$section->classroom->calss_name}}</td>
