                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-4">{{ trans('Teacher_trans.Name_Teacher') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('update_profile',$information->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="checkbox" class="form-check-input" onclick="myFunction()"
                                               id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1">  {{ trans('Parent_trans.Password') }}</label>
                                    </div>
                                </div>
                                <hr>
