                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('quizzes.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">  {{ trans('attendance.exams_add') }}</a><br><br>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{ trans('attendance.exams_name') }}</th>
                                        ...
                                        @foreach($quizes as $quizze)
                                            <tr>
                                                ...
                                                <td>{{$quizze->classroom->calss_name}}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('quizzes.show',$quizze->id)}}"
                                                       class="btn btn-warning btn-sm" title=" {{ trans('attendance.show_test') }}" role="button" aria-pressed="true"><i
                                                            class="fa fa-binoculars"></i></a>

                                                    <a href="{{ route('show_tested_student',$quizze->id) }}"
                                                       class="btn btn-primary btn-sm" title=" {{ trans('attendance.show_testSt') }}" role="button" aria-pressed="true"><i
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;"
                                                                    class="modal-title" id="exampleModalLabel"> {{ trans('attendance.exams_delete') }}</h5>
