                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">   {{ trans('Sections_trans.submit') }} </button>
                            </form>
                        </div>
                    </div>
                </div>
